...
- For non-blocking advanced-feature steering and option framing, keep guidance inline unless the archived `agent-first-adoption-steering` skill is explicitly restored.
